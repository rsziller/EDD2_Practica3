...
namespace Practica3EDD2.model
{
    ...
    public class BTree<T> where T : IComparable<T>
    {
        ...
        public void ShowRec(Dictionary<string, List<string>> dpiContentMap)
        {
            ShowRec(root, dpiContentMap);
        }
        ...
        private void ShowRec(Node x, Dictionary<string, List<string>> dpiContentMap)
        {
            ...
            for (i = 0; i < x.n; i++)
            {
                Console.WriteLine("");
                if (!x.leaf)
                    ShowRec(x.child[i], dpiContentMap);
        ...
        public void decoded(Person persona)
        {
            if (persona!= null)
            {
        ...
        public bool UpdatePersonInfo(long dpi, string newAddress = null, string newBirthDate = null, string[] newCompany = null)
        {
